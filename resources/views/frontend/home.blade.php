...
<section class="container relative max-w-screen-xl py-10 bg-white rounded-md">
  ...
  <section class="container relative max-w-screen-xl py-10 bg-white rounded-md">
    ...
    @if ($category->id == 1)
    <div id="productCarousel1">
        @foreach (@$category->products as $product)
            <div class="w-[300px] h-[250px] rounded-2xl overflow-hidden relative min-h-[760px] md:min-h-[680px] bg-primary ml-[20px]">
  ...
  <section class="container relative max-w-screen-xl py-10">
    ...
    <div id="mitraCarousel">
        @forelse ($airlines as $airline)
            <img class="w-[50%] md:w-[14%] rounded-2xl bg-white mr-[30px]" src="{!! Storage::url($airline->photo) !!}"
                alt="{!! $airline->title !!}">
...
@section('jsCustom')
 ...
 <script>
    ...
    var flktyBrochur = new Flickity('#productCarousel1', {
      cellAlign: 'left',
      imagesLoaded: true,
      contain: true,
      prevNextButtons:false,
    ...
    var flktyBrochur = new Flickity('#productCarousel2', {
      cellAlign: 'left',
      imagesLoaded: true,
      contain: true,
      prevNextButtons:false,
